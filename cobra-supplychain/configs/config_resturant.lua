...
-- jim-payments events (already in use on this server)
-- These are now only fallbacks; the register/pay logic calls jim-payments directly in cl_resturant.lua
Businesses.ResturantBillingEvent = "jim-payments:client:openRegister"
Businesses.CustomerBillingEvent  = "jim-payments:client:openPayment"
        ...
        CookLoco = {
            {
                ...
                -- animation plays during the progress bar — overrides the default bar cycling
                animation   = { dict = "anim@heists@ornate_bank@hack", name = "hack_loop" },
                items = {
                    {
                        item          = "water_bottle",
                        amount        = 1,
                        ...
                        progressAnim  = { dict = "anim@heists@ornate_bank@hack", name = "hack_loop" },
                        requiredItems = {
